    ...
    async def _ensure_browser_initialized(self) -> Any:
        ...
        if self.browser is None:
            ...
            if config.browser_config:
                try:
                    ...
                    pass  # ProxySettings not available in this version
            ...
            # Create Browser directly without BrowserConfig wrapper
        ...
        if self.context is None:
            ...
            try:
                ...
                # Fallback: get the current/default page
                self.context = await self.browser.get_current_page()
...
"""
    ...
    async def get_current_state(self, context: Optional[Any] = None) -> ToolResult:
        """
